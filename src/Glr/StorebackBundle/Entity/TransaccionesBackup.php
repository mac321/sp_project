 ...
 * TransaccionesBackup
 *
 * @ORM\Table(name="Transacciones_Backup", indexes={@ORM\Index(name="fk_Transacciones_0_idx", columns={"idtrn", "idSocio", "pedido_socio"}), @ORM\Index(name="fk_Transacciones_1_idx", columns={"idSocio"}), @ORM\Index(name="fk_Transacciones_2_idx", columns={"idSocio", "pedido_socio", "idtrn"}), @ORM\Index(name="fk_Transacciones_3_idx", columns={"idSocio", "pedido_socio"})})
 * @ORM\Entity
 */
class TransaccionesBackup
{
    /**
     * @var integer
     *
